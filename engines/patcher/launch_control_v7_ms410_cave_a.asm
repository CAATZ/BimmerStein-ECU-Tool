; Launch Control V7 - MS41.0 arm state and independent cut requests.
...
; FD80 is hash-certified free post-startup IRAM on canonical 1429861.
arm:    bset 0xFD80.6
        jmpr cc_UC,request_gate
disarm:
        bclr 0xFD80.6
