; Launch Control V6 - MS41.3 arm state and independent cut requests.
;
; FD5A.6 remains the launch-armed latch. E812.1 is the launch ignition-cut
; request consumed by Ignition Cut V8; E812.2 marks actual launch fuel cut.
...
ignition_mode:
        ...
        movb RL4,0x2A67              ; shared CUT_HYST
        cmpb RL4,#0xFF
