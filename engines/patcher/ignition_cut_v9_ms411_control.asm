; Ignition Cut V9 - MS41.1 control and fixed-IPW hook.
...
fixed_ipw:
        ...
        movb RL5,0x3719               ; LC_IPW low byte
        movb RH5,0x371A               ; LC_IPW high byte
        jmpr cc_UC,ipw_check
standalone_ipw:
        movb RL5,0xE847
        andb RL5,#0x01
        jmpr cc_EQ,done
        movb RL5,0x3703               ; CUT_IPW low byte
        movb RH5,0x3704               ; CUT_IPW high byte
ipw_check:
        cmp  r5,#0xFFFF
        jmpr cc_EQ,done
        mov  0xEF96,r5
