; Launch Control V7 - MS41.1 arm state and independent cut requests.
base 0x3F9C0
...
; FDB6 is hash-certified free post-startup IRAM on canonical 1437806.
arm:    bset 0xFDB6.6
        jmpr cc_UC,request_gate
disarm:
        bclr 0xFDB6.6
...
clear_both:
        ...
        pop  r4
        pop  DPP0
        jmps 0x03FB40                ; relocated soft-limit cave
