; Ignition Cut V8 - MS41.2 cut-active adaptation and diagnostic guards.
;
; E812 must carry the initialized A0 marker and at least one real cut request:
; standalone spark (bit 0), launch spark (bit 1), or launch fuel (bit 2).
; Every inactive path replays the exact displaced stock instruction.
base 0x3E1A0
