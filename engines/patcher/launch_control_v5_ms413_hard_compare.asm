; MS41.3 Launch Control V5 - independently calibrated hard limiter comparator.
;
...
base 0x3DE20
        ...
        jmpr cc_EQ,stock
        movb RL5,0x47E1               ; LC_CUTTYPE: 0=fuel, 1=ignition
        cmpb RL5,#0
        jmpr cc_NE,stock
...
validate:
        cmpb RL5,0x47E3               ; hard threshold must be >= soft
        jmpr cc_NC,compare
        movb RL5,0x47E3               ; fail safe: clamp hard to soft
